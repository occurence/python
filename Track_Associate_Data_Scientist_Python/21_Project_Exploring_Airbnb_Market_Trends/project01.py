...
# airbnb_last_review = pd.read_csv(r'D:\STUDY\python\Track_Associate_Data_Scientist_Python\21_Project_Exploring_Airbnb_Market_Trends\airbnb_last_review.tsv', sep='\t')
...
# listingsApp = pd.merge(airbnb_price, airbnb_room_type, on='listing_id')
# listingsApp = pd.merge(listingsApp, airbnb_last_review, on='listing_id')
# print(listingsApp)


# What are the dates of the earliest and most recent reviews? Store these values as two separate variables with your preferred names.
# print(listings['last_review'].describe())
...
# print(f'The earliest review: {first_reviewed.strftime("%Y-%m-%d")}')
# print(f'The recent review: {last_reviewed.strftime("%Y-%m-%d")}')
