...
X_train_displ = X_train[:, 1].reshape(-1, 1)
print(X_train_displ)
...
dt.fit(X_train_displ, y_train)

# Predict the labels of the training set
y_pred_base = dt.predict(X_train_displ)

# Evaluate the training set RMSE of dt
RMSE_base = (MSE(y_train, y_pred_base))**(1/2)

# Print RMSE_train
print('Train RMSE: {:.2f}'.format(RMSE_base))