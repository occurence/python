...
numeric_categorical_union = ColumnTransformer(
    transformers=[
        ("num", SimpleImputer(strategy="median"), non_categorical_columns),
...
# X_transformed = numeric_categorical_union.fit_transform(X)
# print(pd.DataFrame(X_transformed).isnull().sum())  # Ensure no NaNs remain
