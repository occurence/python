...
# Removing diastolic
# Removing pregnant and insulin
# Keep the only feature with highest coefficient (triceps, bmi, family, age)
...
print("Removing all but one feature only reduced the accuracy by a few percent.")