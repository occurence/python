...
flights_mon_assembled.select('mon','dom','dow','carrier','flight','org','depart','duration','delay','km','org_idx','org_dummy','depart_bucket','depart_dummy','dow_dummy','mon_dummy','features').show(5, truncate=False)
