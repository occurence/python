...
cursor.execute("""
IF DB_ID('tehandling') IS NOT NULL
BEGIN
    ALTER DATABASE tehandling SET SINGLE_USER WITH ROLLBACK IMMEDIATE;
    DROP DATABASE tehandling;
END
""")
conn.commit()

cursor.execute("""
DROP DATABASE IF EXISTS tehandling;
