...
# Transpose np_aw by calling np.transpose() on np_aw. Call the result np_aw_t. Now every row in np_aw_t represents the position after 1 throw for the five random walks.
...
# for x in range(5):
#     print(all_walks[x])
#     plt.plot(all_walks[x], label='walk ' + str(x + 1))
#     plt.show()
